...
public interface FoodInstanceController {
     ...
     * @throws PantsConversionFailedException if the original quantity and the new quantity can't be added
     */
     ...
     * @throws PantsNotFoundException if the given food does not exist
     */
